 ...
 * name, photo, birthday, password, and personalGoal — a private target the
 * seller sets for themselves. This is deliberately a separate field from
 * goal1/goal2, which are the official commission-linked targets the
 * mediator sets via lib/users.ts updateVendor; letting sellers edit goal1
 * directly would let them change their own commission payout threshold. */
